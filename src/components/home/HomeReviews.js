    ...
    <div className='home-reviews-container'>
      ...
      <div className='why-container'>
        <div>
          ...
          <h4>Skilled Staff</h4>
          <p>Both soft skills and technical skills, or hard skills, are equally important in an employee</p>
        </div>
        ...
        <div>
          ...
          <h4>Skilled Staff</h4>
          <p>Contact customer support for all product related queries - including breakdown and accident assistance.</p>
        </div>
        ...
        <div>
          ...
          <h4>Standrad Excellence</h4>
          <p>Standard Excelece with a decades of experience in helping the filipino for their business</p>
        </div>
      </div>
    </div>
  )
