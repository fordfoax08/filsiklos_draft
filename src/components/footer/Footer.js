...
const Footer = () => {
    ...
    useEffect(() => {
        ...
        document.querySelectorAll('a').forEach(a => {
            a.addEventListener("click", scrollTop);
        })
    ...
    return(
        <footer>
            <div>
                <img src='/banners/logo-name-2.png' alt="logo2" />
                <h3>ABOUT US</h3>
                <p>XCompany is a company that aims to give the filipino service by providing easy and cheap motorcycles without any hassle what so ever this is just a sample data sample data sample data.</p>
            ...
            <div className='footer-allrights'>
                <p onDoubleClick={ () => setJad(prev => !prev) }> &copy; Copyrights 2022 | Filsiklos inc. <span className={`builtby ${ jad ? "show" : ""}`}>| Powered By: JAD</span></p>
            </div>
        </footer>
    )
}
